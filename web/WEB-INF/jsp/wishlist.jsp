...
<c:if test="${requestScope.err eq 'error'}">
    <script>
        window.alert("Item already exist in wishlist");
    </script>
</c:if>    
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="actions" colspan="6">
                                                <a href="movetocart.htm?pid1=${ob1.pid}"><input type="button" class="add_to_cart_button" value="Move To Cart"/></a>
                                                <a href="removefromwl.htm?pid1=${ob1.pid}"><input type="button" class="add_to_cart_button" value="Remove From Wishlist"/></a>
