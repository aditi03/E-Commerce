<%-- 
    Document   : checkout
    Created on : Feb 2, 2017, 5:26:11 PM
    Author     : Viraj
--%>
                ...
                <div class="col-md-8">
                    <div class="product-content-right">
                        <div class="woocommerce">
                            ...
                            <form enctype="multipart/form-data" action="laceorder.htm" class="checkout" method="post" name="checkout">
                                    ...
                                    <div class="col-1">
                                        ...
                                        <p id="billing_first_name_field" class="form-row form-row-first validate-required">
                                            ...
                                            <p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
                                                ...
                                                <textbox rows="20" cols="20" name="address"/>
                                            </p>
                                    ...
                                    <div id="payment">
                                        <ul class="payment_methods methods">
                                            <li class="payment_method_bacs">
                                                ...
                                                <label for="payment_method_bacs">Online Banking</label>
