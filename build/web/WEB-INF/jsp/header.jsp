...
<html lang="en">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            <li>Hello,  ${fnm} </li>
                            <li><a href="myaccount.htm"><i class="fa fa-user"></i> My Account</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="header-right">
                        ...
                        <a href="nf.htm"><i class="fa fa-user"></i>Notification</a>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="shopping-item">
                        <a href="displayorder.htm">Order  &nbsp;      <i class="glyphicon glyphicon-briefcase"></i></a>
                    </div>

                    
                    <div class="shopping-item">
                        <a href="cart.htm">Cart  <i class="fa fa-shopping-cart"></i> <span class="product-count">${sessionScope.count}</span></a>
                    </div>
                ...
                <div class="navbar-header">
                 ...
                 <form action="search.htm">
                            <div class="nav-fill">
                                ...
                                <input type="field-keywords" placeholder="Search" tabindex="50" class="nav-input" name="search">
  ...
  <div class="dropdown-content">
    ...
    <a href="mobtab.htm">Mobile and Tablet</a>
    <a href="#">Computers</a>
  </div>
  </li>
  ...
  <li><a href=booklist.htm>Books</a></li>                      
